...
from rcl_interfaces.msg import Parameter, Parameter, ParameterValue, ParameterType
...
class FaceDetectorClient(Node) :
    def __init__(self):
        ...
        # self.test1_image_path = get_package_share_directory( 'demo_python_service') + '/resource/test1.png'
        self.test1_image_path = get_package_share_directory( 'demo_python_service') + '/resource/cury.png'
